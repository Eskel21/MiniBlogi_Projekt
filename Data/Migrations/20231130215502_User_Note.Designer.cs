...
namespace MiniBlogi_Projekt.Data.Migrations
{
    ...
    [Migration("20231130215502_User_Note")]
    partial class User_Note
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniBlogi_Projekt.Data.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("MiniBlogi_Projekt.Data.Models.ImageNote", b =>
                {
                    b.Property<int>("ImageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniBlogi_Projekt.Data.Models.Tag", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MiniBlogi_Projekt.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniBlogi_Projekt.Data.Models.ImageNote", b =>
                {
                    b.HasOne("MiniBlogi_Projekt.Data.Models.Image", "Image")
                        .WithMany("ImageNotes")
            ...
            modelBuilder.Entity("MiniBlogi_Projekt.Data.Models.TagNote", b =>
                {
                    ...
                    b.HasOne("MiniBlogi_Projekt.Data.Models.Tag", "Tag")
                        .WithMany("TagNotes")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
